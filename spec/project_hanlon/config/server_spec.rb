...
describe ProjectHanlon::Config::Server do
  ...
  context "class" do
    subject { ProjectHanlon::Config::Server }
    it { should respond_to "instance" }
  end

  describe ".instance" do
    it "should return the same instance if called twice" do
      ProjectHanlon::Config::Server.instance.object_id.should ==
        ProjectHanlon::Config::Server.instance.object_id
    end
...
YAML
  ...
  describe "save_as_yaml" do
    it "should silently skip if the file exists" do
      ...
      ProjectHanlon::Config::Server.instance.save_as_yaml(unexists.path)
