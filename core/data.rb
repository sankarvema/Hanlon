...
# This class is the interface to all querying and saving of objects for ProjectHanlon
module ProjectHanlon
  class Data
    ...
    # {ProjectHanlon::Config::Server} object for {ProjectHanlon::Data}
    # {ProjectHanlon::Controller} object for {ProjectHanlon::Data}
    attr_accessor :persist_ctrl

    # Initializes our {ProjectHanlon::Data} object
    #  Attempts to load {ProjectHanlon::Configuration} and initialize {ProjectHanlon::Persist::Controller}
    def initialize
    ...
    # Called when work with {ProjectHanlon::Data} is complete
    def teardown
    ...
    # Takes an {ProjectHanlon::Object} and creates/persists it within the database.
    # @note If {ProjectHanlon::Object} already exists it is simply updated
    #
    # @param [ProjectHanlon::Object, Array] object
    # @return [ProjectProjectHanlon::Object] returned object is a copy of passed {ProjectHanlon::Object} with bindings enabled for {ProjectHanlon::ProjectHanlon#refresh_self} and {ProjectHanlon::ProjectHanlon#update_self}
    def persist_object(object, options = {})
      if object.class == Array
        ...
        unless options[:multi_collection]
          raise ProjectHanlon::Error::MissingMultiCollectionOnGroupPersist, "Missing namespace on multiple object  persist"
        end
    ...
    # Removes all {ProjectHanlon::Object}'s that exist in the collection name given
    #
    ...
    # Removes specific {ProjectHanlon::Object} that exist in the collection name given
    #
    # @param [ProjectProjectHanlon::Object] object The {ProjectHanlon::Object} to delete
    # @return [true, false]
    ...
    # Removes specific {ProjectHanlon::Object} that exist in the collection name with given 'uuid'
    #
    # @param [Symbol] object_symbol The name of the collection
    # @param [String] object_uuid The 'uuid' of the {ProjectHanlon::Object}
    # @return [true, false]
    ...
    # Takes a [Hash] from a {ProjectHanlon::Persist:Controller} document and converts back into an {ProjectHanlon::Object}
    # @api private
    # @param [Hash] object_hash The hash of the object
    # @return [ProjectHanlon::Object, ProjectHanlon]
    ...
    # Initiates the {ProjectHanlon::Persist::Controller} for {ProjectHanlon::Data}
    # @api private
    #
    # @return [ProjectHanlon::Persist::Controller, ProjectHanlon]
    def setup_persist
      logger.debug "Persist controller init"
      @persist_ctrl = ProjectHanlon::Persist::Controller.new
    end
