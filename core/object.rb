...
# @abstract
class ProjectHanlon::Object
  # Mixin our ObjectUtilities
  include(ProjectHanlon::Utility)
  include(ProjectHanlon::Logging)

  # There variables are required in all ProjectHanlon objects
  ...
  attr_accessor :_persist_ctrl # instance ref pointing to ProjectHanlon::Persist::Controller of ProjectHanlon::Data that created/fetched this object used for update/refresh
  attr_accessor :_namespace # Collection/Table symbol for ProjectHanlon::Persist::Controller / Must be specified(overridden) in each child class
