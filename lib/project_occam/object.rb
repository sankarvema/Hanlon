...
# Common object for all base ProjectOccam objects
# @abstract
class ProjectOccam::Object
  # Mixin our ObjectUtilities
  include(ProjectOccam::Utility)
  include(ProjectOccam::Logging)

  # There variables are required in all ProjectOccam objects
  ...
  attr_accessor :_persist_ctrl # instance ref pointing to ProjectOccam::Persist::Controller of ProjectOccam::Data that created/fetched this object used for update/refresh
  attr_accessor :_namespace # Collection/Table symbol for ProjectOccam::Persist::Controller / Must be specified(overridden) in each child class
