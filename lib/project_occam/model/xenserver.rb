...
module ProjectOccam
  module ModelTemplate
    # Root Model object
    # @abstract
    class XenServer < ProjectOccam::ModelTemplate::Base
      ...
      def initialize(hash)
        ...
        @req_metadata_hash = {
            ...
            "@ntpserver"               => { :default     => "",
                                            :example     => "ntp.occam.example.local",
                                            :validation  => '^[\w.]{3,}$',
                                            :required    => true,
      ...
      def template_filepath(filename)
        raise ProjectOccam::Error::Slice::InternalError, "must provide xenserver version." unless @osversion
