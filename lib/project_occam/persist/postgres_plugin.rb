...
module ProjectOccam
  module Persist
    # PostgreSQL version of {ProjectOccam::Persist::PluginInterface}
    # used by {ProjectOccam::Persist::Controller} when ':postgres' is the 'persist_mode'
    # in ProjectOccam configuration
    class PostgresPlugin < PluginInterface
      ...
      # Establishes connection to PostgreSQL database with the name "project_occam". The
