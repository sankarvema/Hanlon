...
module ProjectOccam
  module PolicyTemplate
    # ProjectOccam Policy Default class
    # Used for default booting of Occam MK
    class BootMK < ProjectOccam::PolicyTemplate::Base
      ...
      # TODO - add logging ability from iPXE back to Occam for detecting node errors
