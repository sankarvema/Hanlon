...
require 'project_occam/persist/controller'

require "yaml"
require "singleton"

# This class is the interface to all querying and saving of objects for ProjectOccam
module ProjectOccam
  class Data
    include Singleton
    include(ProjectOccam::Utility)
    include(ProjectOccam::Logging)

    # {ProjectOccam::Config::Server} object for {ProjectOccam::Data}
    # {ProjectOccam::Controller} object for {ProjectOccam::Data}
    attr_accessor :persist_ctrl

    # Initializes our {ProjectOccam::Data} object
    #  Attempts to load {ProjectOccam::Configuration} and initialize {ProjectOccam::Persist::Controller}
    def initialize
    ...
    # Called when work with {ProjectOccam::Data} is complete
    def teardown
    ...
    # Takes an {ProjectOccam::Object} and creates/persists it within the database.
    # @note If {ProjectOccam::Object} already exists it is simply updated
    #
    # @param [ProjectOccam::Object, Array] object
    # @return [ProjectProjectOccam::Object] returned object is a copy of passed {ProjectOccam::Object} with bindings enabled for {ProjectOccam::ProjectOccam#refresh_self} and {ProjectOccam::ProjectOccam#update_self}
    def persist_object(object, options = {})
      if object.class == Array
        ...
        unless options[:multi_collection]
          raise ProjectOccam::Error::MissingMultiCollectionOnGroupPersist, "Missing namespace on multiple object  persist"
        end
    ...
    # Removes all {ProjectOccam::Object}'s that exist in the collection name given
    #
    ...
    # Removes specific {ProjectOccam::Object} that exist in the collection name given
    #
    # @param [ProjectProjectOccam::Object] object The {ProjectOccam::Object} to delete
    # @return [true, false]
    ...
    # Removes specific {ProjectOccam::Object} that exist in the collection name with given 'uuid'
    #
    # @param [Symbol] object_symbol The name of the collection
    # @param [String] object_uuid The 'uuid' of the {ProjectOccam::Object}
    # @return [true, false]
    ...
    # Takes a [Hash] from a {ProjectOccam::Persist:Controller} document and converts back into an {ProjectOccam::Object}
    # @api private
    # @param [Hash] object_hash The hash of the object
    # @return [ProjectOccam::Object, ProjectOccam]
    ...
    # Initiates the {ProjectOccam::Persist::Controller} for {ProjectOccam::Data}
    # @api private
    #
    # @return [ProjectOccam::Persist::Controller, ProjectOccam]
    def setup_persist
      logger.debug "Persist controller init"
      @persist_ctrl = ProjectOccam::Persist::Controller.new
    end
