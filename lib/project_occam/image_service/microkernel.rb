...
module ProjectOccam
  module ImageService
    ...
    class MicroKernel < ProjectOccam::ImageService::Base
      ...
      # are used to determine which ISO to use when multiple Occam-Microkernel
      ...
      # in the Occam-Microkernel project over time.  The following four version
      ...
      # Occam-Microkernel release.  The remainder (if it exists) shows the commit
      ...
      def version_weight
        ...
        # older versions of the Occam-Microkernel project)
