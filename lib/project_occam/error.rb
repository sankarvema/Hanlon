...
require "project_occam/error/generic"
require "require_all"
...
module ProjectOccam
  module Error
    ...
    def self.create_class(new_class, error_code, val={}, msg='', parent_str='ProjectOccam::Error::Generic')
      ...
      parent = ProjectOccam::Error.contantize(parent_str)
      parent_module_str = parent_str.split('::')[0..-2].join('::')
      parent_module = ProjectOccam::Error.contantize(parent_module_str)
    ...
    [
        [ 'CannotCreatePolicyTable'                , 10 , {'@http_err' => :bad_request}            , ''          , 'ProjectOccam::Error::Generic' ],
        [ 'MissingMultiCollectionOnGroupPersist'   , 31 , {'@http_err' => :internal_server_error}  , ''          , 'ProjectOccam::Error::Generic' ],
    ].each do |err|
