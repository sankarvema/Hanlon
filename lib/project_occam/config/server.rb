...
# This class represents the ProjectOccam configuration. It is stored persistently in
# './conf/occam_server.conf' and editing by the user
module ProjectOccam
  module Config
    class Server
      include ProjectOccam::Utility
      include ProjectOccam::Logging
      extend  ProjectOccam::Logging
      ...
      attr_accessor :mk_register_path # : /project_occam/api/v1/node/register
      attr_accessor :mk_checkin_path # checkin: /project_occam/api/v1/node/checkin
      ...
      # from the 'service.yaml' file used to configure the Occam server instance
      ...
      def self.instance
        unless @_instance
          ...
          if config.is_a? ProjectOccam::Config::Server
          ...
          unless config
            config = ProjectOccam::Config::Server.new
      ...
      def defaults
        ...
        defaults = {
          ...
          # e.g. "console=ttyS0" or "occam.ip=1.2.3.4"
      ...
      ConfigHeader = <<EOT
#
# This file is the main configuration for ProjectOccam
#
...
EOT
      ...
      # address to use when constructing the Occam configuration file)
      def local_ip
      ...
      # for the Occam server when constructing the Occam configuration file.  It returns
