...
def default_config
  ProjectHanlon::Config::Server.new
end
...
describe ProjectHanlon::Data do
  ...
  describe ".PersistenceController" do
    ...
    it "should create an Persistence Controller object with passed config" do
      @data.persist_ctrl.kind_of?(ProjectHanlon::Persist::Controller).should == true
    end
  ...
  describe ".Nodes" do
    ...
    before(:all) do
      ...
      |x|
        temp_node = ProjectHanlon::Node.new({:@name => "rspec_node_junk#{x}", :@last_state => :idle, :@current_state => :idle, :@next_state => :policy_applied})
    ...
    it "should get a single node by UUID" do
      ...
      node.is_a?(ProjectHanlon::Node).should == true
    ...
    it "should be able to add a new Node (does not exist) and update" do
      temp_node = ProjectHanlon::Node.new({:@name => "rspec_node_junk_new", :@last_state => :idle, :@current_state => :idle, :@next_state => :policy_applied})
      temp_node = @data.persist_object(temp_node)
      temp_node.update_self
    ...
    it "should be able to delete a specific Node by uuid" do
      temp_node = ProjectHanlon::Node.new({:@name => "rspec_node_junk_delete_uuid", :@last_state => :idle, :@current_state => :idle, :@next_state => :policy_applied})
      temp_node = @data.persist_object(temp_node)
      temp_node.update_self
    ...
    it "should be able to delete a specific Node by object" do
      temp_node = ProjectHanlon::Node.new({:@name => "rspec_node_junk_delete_object", :@last_state => :idle, :@current_state => :idle, :@next_state => :policy_applied})
      temp_node = @data.persist_object(temp_node)
      temp_node.update_self
    ...
    it "should be able to update Node attributes for existing Node" do
      ...
      node_confirm.is_a?(ProjectHanlon::Node).should == true
    ...
    # the ProjectHanlon::Node object; so these tests are no longer valid
  ...
  #    (1..NODE_COUNT).each do
  #    |x|
  #      temp_model = ProjectHanlon::Model::Base.new({:@name => "rspec_model_junk#{x}", :@model_type => :base, :@values_hash => {}})
  ...
  #    model.is_a?(ProjectHanlon::Model::Base).should == true
  #
  ...
  #    temp_model = ProjectHanlon::Model::Base.new({:@name => "rspec_model_junk_new", :@last_state => :idle, :@current_state => :idle, :@next_state => :policy_applied})
  #    temp_model = @data.persist_object(temp_model)
  #    temp_model.update_self
  #
  ...
  #    temp_model = ProjectHanlon::Model::Base.new({:@name => "rspec_model_junk_delete_uuid", :@last_state => :idle, :@current_state => :idle, :@next_state => :policy_applied})
  #    temp_model = @data.persist_object(temp_model)
  #    temp_model.update_self
  #
  #    model = @data.fetch_object_by_uuid(:model, temp_model.uuid)
  ...
  #    temp_model = ProjectHanlon::Model::Base.new({:@name => "rspec_model_junk_delete_object", :@last_state => :idle, :@current_state => :idle, :@next_state => :policy_applied})
  #    temp_model = @data.persist_object(temp_model)
  #    temp_model.update_self
  #
  #    model = @data.fetch_object_by_uuid(:model, temp_model.uuid)
  ...
  #    model_confirm.is_a?(ProjectHanlon::Model::Base).should == true
  ...
  #    (1..NODE_COUNT).each do
  #    |x|
  #      temp_policy = ProjectHanlon::Policy::Base.new({:@name => "rspec_policy_junk#{x}", :@policy_type => :base, :@model => :base})
  ...
  #    policy.is_a?(ProjectHanlon::Policy::Base).should == true
  #
  ...
  #    temp_policy = ProjectHanlon::Policy::Base.new({:@name => "rspec_policy_junk_new", :@last_state => :idle, :@current_state => :idle, :@next_state => :policy_applied})
  #    temp_policy = @data.persist_object(temp_policy)
  #    temp_policy.update_self
  #
  ...
  #    temp_policy = ProjectHanlon::Policy::Base.new({:@name => "rspec_policy_junk_delete_uuid", :@last_state => :idle, :@current_state => :idle, :@next_state => :policy_applied})
  #    temp_policy = @data.persist_object(temp_policy)
  #    temp_policy.update_self
  #
  #    policy = @data.fetch_object_by_uuid(:policy, temp_policy.uuid)
  ...
  #    temp_policy = ProjectHanlon::Policy::Base.new({:@name => "rspec_policy_junk_delete_object", :@last_state => :idle, :@current_state => :idle, :@next_state => :policy_applied})
  #    temp_policy = @data.persist_object(temp_policy)
  #    temp_policy.update_self
  #
  #    policy = @data.fetch_object_by_uuid(:policy, temp_policy.uuid)
  ...
  #    policy_confirm.is_a?(ProjectHanlon::Policy::Base).should == true
