...
(function() {
  ...
  SwaggerApi = (function() {
    ...
    SwaggerApi.prototype.discoveryUrl = null;

    SwaggerApi.prototype.debug = false;

    SwaggerApi.prototype.basePath = null;

    SwaggerApi.prototype.discoveryBaseUrl = null;

    SwaggerApi.prototype.discoveryUrlPath = null;

    SwaggerApi.prototype.discoveryPath = null;
    ...
    function SwaggerApi(options) {
      ...
      this.discoveryBaseUrl = /^(((http[s]?|ftp):\/)?\/?([^:\/\s]+)([:](\d+))?)/.exec(this.discoveryUrl)[1];
      this.discoveryUrlPath = this.discoveryUrl.substring(0, this.discoveryUrl.lastIndexOf('/'));
      this.discoveryPath = /^(((http[s]?|ftp):\/)?\/?([^:\/\s]+)([:](\d+))?)(.*)$/.exec(this.discoveryUrlPath)[7];
    ...
    SwaggerApi.prototype.build = function() {
      ...
      return jQuery.getJSON(this.discoveryUrl, function(response) {
        ...
        if ((response.basePath != null) && jQuery.trim(response.basePath).length > 0) {
          ...
          if (_this.basePath === _this.discoveryBaseUrl || _this.basePath.match(/^\//)) {
            _this.basePath = _this.discoveryUrlPath;
  ...
  SwaggerOperation = (function() {
    ...
    SwaggerOperation.prototype.urlify = function(args) {
      ...
      if (this.resource.basePath === this.resource.api.discoveryBaseUrl) {
        this.resource.basePath = this.resource.api.discoveryPath;
      }
    ...
    SwaggerOperation.prototype.getQueryAndHeaderParams = function(args) {
      return this.getMatchingParams(['query', 'header'], args);
    };
